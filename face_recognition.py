...
class FaceRecognition:
    ...
    def __init__(self, cascade_path, screen_width, screen_height):
        """
            cascade_path: Путь к XML-файлу каскада Хаара для распознавания лиц.
            screen_width: Ширина экрана, на котором будут отображаться координаты.
            screen_height: Высота экрана, на котором будут отображаться координаты.
        """
